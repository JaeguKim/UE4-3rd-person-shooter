...
void ASTrackerBot::OnCheckNearbyBots()
{
	...
	// Create temporary collison shape for overlaps
	FCollisionShape CollShape;
	CollShape.SetSphere(Radius);

	// Only find Pawns (eg. players and AI bots)
	FCollisionObjectQueryParams QueryParams;
	// Out tracker bot's mesh component is set to physics Body in Blueprint (default profile of physics simulated actors)
	...
	if (MatInst)
	{
		...
		// Which can be tweaked many times by gameplay decisions (would mean we need to keep 2 pieces up to date)
